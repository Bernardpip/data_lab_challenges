...
FICHIERS_DONNEES = [
    ...
    "repartition-des-etablissements-denseignement-superieur-ayant-fonctionne-"
    "par-type-statut-et-localisation-geographique.csv",
    ...
    "chomage-des-diplomes-de-lenseignement-superieur-de-la-population-active-"
    "totale-diplomee-de-lenseignement-superieur-.csv",
]
...
def main():
    print()
    print(_teinte("  Adéquation formation-emploi au Togo — diagnostic", "1"))
    print("  Data Challenge Éducation · Défi 2")
